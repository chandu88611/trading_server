...
class CopyTradingRouter {
    ...
    init() {
        ...
        // Alias used by frontend copyTrading.api.ts
        this.router.post("/follows", (0, auth_1.requireAuth)([auth_1.Roles.USER, auth_1.Roles.ADMIN]), controller.followMaster.bind(controller));
