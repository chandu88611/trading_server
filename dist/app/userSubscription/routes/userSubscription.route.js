...
class UserSubscriptionRouter {
    ...
    initRoutes() {
        ...
        this.router.get("/subscription/follower-user-trading-account", (0, auth_1.requireAuth)([auth_1.Roles.USER]), controller.followerUserTradingAccount.bind(controller));
        ...
        this.router.post("/admin/subscription/update-webhook", (0, auth_1.requireAuth)([auth_1.Roles.ADMIN]), controller.updateWebhookStatus.bind(controller));
        this.router.patch("/subscription/strategy-selections", (0, auth_1.requireAuth)([auth_1.Roles.USER]), controller.saveStrategySelections.bind(controller));
        this.router.patch("/subscription/webhook-settings", (0, auth_1.requireAuth)([auth_1.Roles.USER]), controller.saveWebhookSettings.bind(controller));
    }
    getRouter() {
        return this.router;
    }
