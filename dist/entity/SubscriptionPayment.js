...
__decorate([
    (0, typeorm_1.Column)({ name: "gateway_event_id", type: "text", unique: true, nullable: true }),
    __metadata("design:type", Object)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => SubscriptionInvoice_1.SubscriptionInvoice, { onDelete: "SET NULL" }),
